...
import { DARK_GRAY, GRAY, PURPLE, REACT_GRAY, WHITE } from '@src/utils/phantomUtils/constants';
import Button from '../Button';
import { ConnectedAccounts, ConnectedMethods } from '../../App';
import { SupportedChainIcons, SupportedChainNames, SupportedEVMChainIds } from '@src/utils/phantomUtils/types';
...
const Sidebar = React.memo((props: Props) => {
  const { connectedAccounts, connectedMethods, handleConnect } = usePhantom();
  return (
    <Main>
      <Body>
        <Link>
        ...
        {connectedAccounts ? (
          ...
          <>
            <div>
              ...
              <AccountRow>
                <Badge>{connectedAccounts?.toBase58()}</Badge>
              </AccountRow>
              <Divider />
            </div>
            <ChainHeader>
